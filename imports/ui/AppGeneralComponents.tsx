        ...
        return (
            ...
            >
                ...
                {this.state.drawerOptions ? (
                    <DrawerContainer {...this.state.drawerOptions} theme={this.props.theme} />
                ) : null}
                {this.state.windowOptions ? (
                    <WindowContainer {...this.state.windowOptions} theme={this.props.theme} />
                ) : null}
                {this.state.modalOptions ? (
                    <ModalContainer {...this.state.modalOptions} theme={this.props.theme} />
                ) : null}
